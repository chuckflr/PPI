					...
					<div class="section_wrapper clearfix">
						...
						<div id="Filters" class="column one <?php echo $filters_class; ?>">
							...
							<ul class="filters_buttons">
								...
								<li class="reset"><a class="close" data-rel="*" href="http://www.ppibusinessservices.com/hcm/news/"><i class="icon-cancel"></i><?php echo $translate['all']; ?></a></li>
							</ul>
			...
			<div class="section <?php echo $section_class; ?>">
				<div class="section_wrapper clearfix">
					...
					<div class="column one column_blog">	
						<div class="blog_wrapper isotope_wrapper" id="blog-post-wrapper">
