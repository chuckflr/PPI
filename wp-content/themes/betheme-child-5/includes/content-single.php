...
<?php 
	...
	?>
		<div class="section section-post-header">
			<div class="section_wrapper clearfix">
				<div class="column one" style="background-color: <?php echo $bg_color; ?>; display: flex;
    justify-content: center; margin:0; padding-top:.5em; padding-bottom: .5em;">
    ...
    background-color: #fff;">
                <?php 
										if($post_cat == "Breaking News"){
                        echo "<img src='/wp-content/uploads/sites/2/2017/10/breaking_news.svg' style='height:85px; width:85px;'>";
                    } else if($post_cat == "Newsletter"){
                        echo "<img src='/wp-content/uploads/sites/2/2017/10/newsletter.svg' style='height:85px; width:85px;'>";
                    } else if($post_cat == "Employment Law Updates"){
                        echo "<img src='/wp-content/uploads/sites/2/2017/10/employment_law_updates.svg' style='height:85px; width:85px;'>";
                    } else if($post_cat == "New Features"){
                        echo "<img src='/wp-content/uploads/sites/2/2017/10/iconfinder-icon.svg' style='height:85px; width:85px;'>";
                    } else {
                        echo "<img src='/wp-content/uploads/sites/2/2017/10/other.svg' style='height:85px; width:85px;'>";
                    }
